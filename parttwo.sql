...
# And set the variables data types to their proper types for proper optimization
...
# Insert values into personal_information with their respective types
...
# This is to be used to reference it from other tables
...
ALTER TABLE payment_information ADD FOREIGN KEY (userid) REFERENCES personal_information(userid);
...
ALTER TABLE contact_information ADD FOREIGN KEY (userid) REFERENCES personal_information(userid);
